...
d3.queue()
  .defer(
    d3.json,
    'https://cdn.rawgit.com/purmac/63823c7401819b53b6afcd55c21af482/raw/5f86bfdc3438c4f6731439f71ecf179f58173429/cvs_7eleven.json'
  )
  .defer(
    d3.json,
    'https://cdn.rawgit.com/purmac/63823c7401819b53b6afcd55c21af482/raw/5f86bfdc3438c4f6731439f71ecf179f58173429/cvs_familymart.json'
  )
  .defer(
    d3.json,
    'https://cdn.rawgit.com/purmac/63823c7401819b53b6afcd55c21af482/raw/5f86bfdc3438c4f6731439f71ecf179f58173429/cvs_ok.json'
  )
  .defer(
    d3.json,
    'https://cdn.rawgit.com/purmac/63823c7401819b53b6afcd55c21af482/raw/5f86bfdc3438c4f6731439f71ecf179f58173429/cvs_hilife.json'
  )
  .await(visualize);
...
function visualize(error, seven, family, ok, hilife) {
  ...
  var cvs_layer = {
    '7-Eleven': seven_layer,
    'Family Mart': family_layer,
    'Hi-Life': hilife_layer,
    'OK Mart': ok_layer,
    Heatmap: heatmap
  };
    ...
    for (var area in d[city]) {
      for (var i = 0; i < d[city][area].storeList.length; i++) {
        geojson = {
          type: 'Point',
          coordinates: [
            d[city][area].storeList[i].Longitude,
            d[city][area].storeList[i].Latitude
          ]
        };
        coord.push(
          L.latLng(
